...
#define instruction_new_bank(x) struct instruction * x = {0}
...
// supply fake registers for testing
int register_r1 = 0;
int register_r2 = 0;
int register_r3 = 0;
...
// int main()
// {
//     Expression_Assign("register_r1", &register_r1);
//     Expression_Assign("register_r2", &register_r2);
//     Expression_Assign("register_r3", &register_r3);
//     init_table();
...
//     cpu_decode(table_types, table_registers, test, 0);
//     cpu_decode(table_types, table_registers, test, 1);
//     cpu_decode(table_types, table_registers, test, 2);
//     cpu_decode(table_types, table_registers, test, 3);
