...
#ifdef lex_lemon_handle_d_option_h
#include "lex/lemon/handle_d_option.h"
#endif
...
#include "lex/lemon/main/struct/s_options/options.h"
  ...
  Symbol_new("$");
#ifdef lex_lemon_main_h
#include "lex/lemon/main.h"
#endif
...
#include "lex/lemon/parseonetoken/switch/WAITING_FOR_DECL_KEYWORD.h"
    ...
    case WAITING_FOR_CLASS_TOKEN:
      ...
      break;
#ifdef lex_lemon_parseonetoken_switch_WAITING_FOR_CLASS_TOKEN_h
#include "lex/lemon/parseonetoken/switch/WAITING_FOR_CLASS_TOKEN.h"
#endif
...
{
  static char templatename[] = "lexer_lempar.c";
  char buf[1000];
  FILE *in;
  char *tpltname;
  char *cp;
