...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    20,    3,    4,    1,    2,    3,    4,    1,    2,   18,
 /*    10 */     5,   16,    6,   19,    7,    8,    9,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     0,    1,    2,    3,    4,    1,    2,    3,    4,    6,
 /*    10 */     7,    5,    7,    8,    7,    7,    7,    8,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    17,   17,   17,   17,   17,   17,   24,   23,   22,   21,
};
...
static const struct {
  ...
  {    6,   -1 }, /* (0) program ::= expr */
  {    7,   -3 }, /* (1) expr ::= expr MINUS expr */
  {    7,   -3 }, /* (2) expr ::= expr PLUS expr */
  {    7,   -3 }, /* (3) expr ::= expr TIMES expr */
  {    7,   -3 }, /* (4) expr ::= expr DIVIDE expr */
  {    7,   -1 }, /* (5) expr ::= INTEGER */
};
